defmodule ProtobufExpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ProtobufExpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ProtobufExpWeb.Gettext, "errors", msg, opts)
    end
  end
